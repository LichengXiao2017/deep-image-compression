...
#### Comparison of Balle (2018) and other approaches using a RD-curve over Kodak dataset:
![image of baseline comparison](https://github.com/LichengXiao2017/deep-image-compression/blob/master/deep_image_compression/static/img/baseline_comparison.png)
